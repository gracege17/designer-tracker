      ...
      <div className="flex-grow flex flex-col items-center justify-center px-6 pt-12 pb-8">
        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#EC5429] text-white font-medium py-2 px-4 transition-all duration-200 flex items-center justify-center gap-3 hover:bg-[#F76538] active:scale-[0.98]"
          >
